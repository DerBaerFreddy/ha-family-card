...
const EN: Dict = {
  ...
  l_shared_todo: "Shared to-do lists",
  ...
  h_todo: "Open items from these to-do lists are shown directly in the calendar",
  h_shared_todo:
    "Items from these to-do lists are shown once as shared entries instead of inside a single person column",
...
const DE: Dict = {
  ...
  l_shared_todo: "Gemeinsame To-do-Listen",
  ...
  h_todo: "Offene Einträge aus diesen To-do-Listen werden direkt im Kalender angezeigt",
  h_shared_todo:
    "Einträge aus diesen To-do-Listen werden einmal als gemeinsame Einträge dargestellt statt nur in einer Personenspalte",
